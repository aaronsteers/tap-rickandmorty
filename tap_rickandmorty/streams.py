...
class CharactersStream(RickAndMortyStream):
    ...
    schema = th.PropertiesList(
        th.Property("id", th.IntegerType, description="The id of the character."),
        th.Property("name", th.StringType, description="The name of the character."),
        th.Property(
            "status",
            th.StringType,
        ...
        th.Property(
            "species", th.StringType, description="The species of the character."
        ),
        th.Property(
            "type",
            th.StringType,
...
class EpisodesStream(RickAndMortyStream):
    ...
    schema = th.PropertiesList(
        th.Property("id", th.IntegerType, description="The id of the episode."),
...
class LocationsStream(RickAndMortyStream):
    ...
    replication_key = None
    schema = th.PropertiesList(
        th.Property("id", th.IntegerType, description="The id of the location."),
        th.Property("name", th.StringType, description="The name of the location."),
        th.Property(
            "type",
            th.StringType,
